                                ...
                                <el-col :span="24">
                                    <el-collapse v-model="activeName" accordion>
                                        <el-collapse-item name="1">
                                            ...
                                            <el-row>
                                                <el-col v-if="flowPathData.FTitle" :span="24">
                                                    <div @click="toFlowPage" class="label_txt">{{flowPathData.FTitle}} {{flowPathData.FStartDate}}</div>
                                                </el-col>
                                            </el-row>
                                        </el-collapse-item>
                                        <el-collapse-item v-if="type == '1'" name="2">
                                            <template slot="title">
                                                <img class="icon_collapse" src="../img/collapse_icon.png" alt="">进度反馈
                                            </template>
                                            <div v-if="currentStatus == '3'" role="alert" class="el-alert el-alert--warning is-light">
                                        ...
                                        <el-collapse-item v-if="type == '1'" name="3">
                                            <template slot="title">
                                                <img class="icon_collapse" src="../img/collapse_icon.png" alt="">交付与回款
                                            </template>
                                            <el-col :span="24">
                                                <div class="label_txt">项目订单管理</div>
                                            </el-col>
                                            <el-col :span="24">
